...
-- Presidencial (Bloco 3, 1 Cobertura)
(2, 6, 601, (SELECT ID_CATEGORIA FROM CATEGORIA_QUARTO WHERE NOME_CATEGORIA = 'Presidencial'), 'DISPONIVEL'),
(2, 6, 602, (SELECT ID_CATEGORIA FROM CATEGORIA_QUARTO WHERE NOME_CATEGORIA = 'Presidencial'), 'DISPONIVEL'); -- ATUALIZADO: Estava Ocupado, mas sem reserva vinculada. Alterado para Disponível.

-- ==================================================================================
-- 8. RESERVAS (AGORA COM DATA_INICIO ÀS 14:00 E DATA_FIM ÀS 12:00)
-- ==================================================================================

-- CENÁRIO 1: Reserva Finalizada (Checkout feito) - Quarto 102 (Standard)
-- De 01/10 (14h) a 05/10 (12h)
...
-- Inicio: HOJE às 14:00 | Fim: Daqui a 3 dias às 12:00
INSERT INTO RESERVA (DATA_INICIO, DATA_FIM, DATA_CHECKIN, DATA_CHECKOUT, VALOR_RESERVA, FORMA_PAGAMENTO, STATUS_RESERVA, ID_CATEGORIA, ID_QUARTO, ID_HOSPEDE, ID_FUNCIONARIO) VALUES
    (
        DATEADD('HOUR', 14, CAST(CURRENT_DATE AS TIMESTAMP)),
        DATEADD('HOUR', 12, CAST(DATEADD('DAY', 3, CURRENT_DATE) AS TIMESTAMP)),
        CURRENT_TIMESTAMP,
        NULL,
        450.00, 'PIX', 'CHECKIN',
        (SELECT ID_CATEGORIA FROM CATEGORIA_QUARTO WHERE NOME_CATEGORIA = 'Standard'),
...
-- Inicio: Daqui 1 mês (14h) | Fim: +5 dias (12h)
INSERT INTO RESERVA (DATA_INICIO, DATA_FIM, DATA_CHECKIN, DATA_CHECKOUT, VALOR_RESERVA, FORMA_PAGAMENTO, STATUS_RESERVA, ID_CATEGORIA, ID_QUARTO, ID_HOSPEDE, ID_FUNCIONARIO) VALUES
    (
        DATEADD('HOUR', 14, CAST(DATEADD('MONTH', 1, CURRENT_DATE) AS TIMESTAMP)),
        DATEADD('HOUR', 12, CAST(DATEADD('DAY', 5, DATEADD('MONTH', 1, CURRENT_DATE)) AS TIMESTAMP)),
        NULL, NULL, 1400.00, 'CREDITO', 'RESERVADO',
...
INSERT INTO RESERVA (DATA_INICIO, DATA_FIM, DATA_CHECKIN, DATA_CHECKOUT, VALOR_RESERVA, FORMA_PAGAMENTO, STATUS_RESERVA, ID_CATEGORIA, ID_QUARTO, ID_HOSPEDE, ID_FUNCIONARIO) VALUES
    (
        DATEADD('HOUR', 14, CAST(DATEADD('DAY', 10, CURRENT_DATE) AS TIMESTAMP)),
        DATEADD('HOUR', 12, CAST(DATEADD('DAY', 12, CURRENT_DATE) AS TIMESTAMP)),
        NULL, NULL, 300.00, 'DINHEIRO', 'CANCELADO',
        (SELECT ID_CATEGORIA FROM CATEGORIA_QUARTO WHERE NOME_CATEGORIA = 'Standard'),
        NULL,
...
INSERT INTO RESERVA (DATA_INICIO, DATA_FIM, DATA_CHECKIN, DATA_CHECKOUT, VALOR_RESERVA, FORMA_PAGAMENTO, STATUS_RESERVA, ID_CATEGORIA, ID_QUARTO, ID_HOSPEDE, ID_FUNCIONARIO) VALUES
    (
        DATEADD('HOUR', 14, CAST(DATEADD('DAY', 7, CURRENT_DATE) AS TIMESTAMP)),
        DATEADD('HOUR', 12, CAST(DATEADD('DAY', 10, CURRENT_DATE) AS TIMESTAMP)),
        NULL, NULL, 840.00, 'VOUCHER', 'RESERVADO',
        (SELECT ID_CATEGORIA FROM CATEGORIA_QUARTO WHERE NOME_CATEGORIA = 'Master'),
...
INSERT INTO RESERVA (DATA_INICIO, DATA_FIM, DATA_CHECKIN, DATA_CHECKOUT, VALOR_RESERVA, FORMA_PAGAMENTO, STATUS_RESERVA, ID_CATEGORIA, ID_QUARTO, ID_HOSPEDE, ID_FUNCIONARIO) VALUES
    ('2022-12-31 14:00:00', '2023-01-02 12:00:00', '2022-12-31 18:00:00', '2023-01-02 11:00:00', 2400.00, 'CREDITO', 'CHECKOUT',
     ...
     (SELECT ID_QUARTO FROM QUARTO WHERE NUM_APARTAMENTO = 601),
     (SELECT ID_HOSPEDE FROM HOSPEDE WHERE NOME_HOSPEDE LIKE 'Fernanda%'),
     (SELECT ID_FUNCIONARIO FROM FUNCIONARIO WHERE NOME_FUNCIONARIO LIKE 'Carlos%'));
...
INSERT INTO RESERVA (DATA_INICIO, DATA_FIM, DATA_CHECKIN, DATA_CHECKOUT, VALOR_RESERVA, FORMA_PAGAMENTO, STATUS_RESERVA, ID_CATEGORIA, ID_QUARTO, ID_HOSPEDE, ID_FUNCIONARIO) VALUES
    (
        DATEADD('HOUR', 14, CAST(CURRENT_DATE AS TIMESTAMP)),
        DATEADD('HOUR', 12, CAST(DATEADD('DAY', 1, CURRENT_DATE) AS TIMESTAMP)),
        CURRENT_TIMESTAMP, NULL, 150.00, 'DEBITO', 'CHECKIN',
        (SELECT ID_CATEGORIA FROM CATEGORIA_QUARTO WHERE NOME_CATEGORIA = 'Standard'),
        (SELECT ID_QUARTO FROM QUARTO WHERE NUM_APARTAMENTO = 101),
        (SELECT ID_HOSPEDE FROM HOSPEDE WHERE NOME_HOSPEDE LIKE 'Pedro%'),
        (SELECT ID_FUNCIONARIO FROM FUNCIONARIO WHERE NOME_FUNCIONARIO LIKE 'Ana%'));

-- CENÁRIO 11: CHECKOUT HOJE - Para testar relatórios
INSERT INTO RESERVA (DATA_INICIO, DATA_FIM, DATA_CHECKIN, DATA_CHECKOUT, VALOR_RESERVA, FORMA_PAGAMENTO, STATUS_RESERVA, ID_CATEGORIA, ID_QUARTO, ID_HOSPEDE, ID_FUNCIONARIO) VALUES
    (
        DATEADD('HOUR', 14, CAST(DATEADD('DAY', -3, CURRENT_DATE) AS TIMESTAMP)),
        DATEADD('HOUR', 12, CAST(CURRENT_DATE AS TIMESTAMP)), -- Fim hoje às 12:00
        DATEADD('DAY', -3, CURRENT_TIMESTAMP),
        CURRENT_TIMESTAMP,
        1350.00, 'PIX', 'CHECKOUT',
        (SELECT ID_CATEGORIA FROM CATEGORIA_QUARTO WHERE NOME_CATEGORIA = 'Deluxe'),
...
-- ==================================================================================
-- 12. CENÁRIOS DE CANCELAMENTO COM MULTA (TESTE DE RELATÓRIO)
-- Regra: < 24h (100%), < 72h (50%), > 72h (0%)
-- ==================================================================================

-- CASO A: MULTA TOTAL (100%) - Cancelou "em cima da hora"
-- Reserva era para AMANHÃ às 14:00. Cancelou HOJE. Diferença < 24h.
-- Valor Reserva: 1000.00 -> Multa Esperada: 1000.00
INSERT INTO RESERVA (DATA_INICIO, DATA_FIM, DATA_CHECKIN, DATA_CHECKOUT, VALOR_RESERVA, FORMA_PAGAMENTO, STATUS_RESERVA, ID_CATEGORIA, ID_QUARTO, ID_HOSPEDE, ID_FUNCIONARIO) VALUES
    (
        DATEADD('HOUR', 14, CAST(DATEADD('DAY', 1, CURRENT_DATE) AS TIMESTAMP)), -- Amanhã 14:00
        DATEADD('HOUR', 12, CAST(DATEADD('DAY', 3, CURRENT_DATE) AS TIMESTAMP)),
        NULL, NULL,
        1000.00, 'PIX', 'CANCELADO',
        (SELECT ID_CATEGORIA FROM CATEGORIA_QUARTO WHERE NOME_CATEGORIA = 'Deluxe'),
        NULL,
        (SELECT ID_HOSPEDE FROM HOSPEDE WHERE NOME_HOSPEDE LIKE 'Fernanda%'),
        (SELECT ID_FUNCIONARIO FROM FUNCIONARIO WHERE NOME_FUNCIONARIO LIKE 'Lucio%')
...
INSERT INTO CANCELAMENTO (MOTIVO, DATA_CANCELAMENTO, VALOR_MULTA, ID_RESERVA) VALUES
    (
        'Imprevisto de saúde urgente',
        CURRENT_TIMESTAMP, -- Cancelou agora
        1000.00,           -- O Service calculou 100% e salvou aqui
        (SELECT MAX(ID_RESERVA) FROM RESERVA WHERE STATUS_RESERVA = 'CANCELADO' AND VALOR_RESERVA = 1000.00)
    );

-- CASO B: MULTA PARCIAL (50%) - Cancelou com 2 dias de antecedência
-- Reserva para daqui a 2 DIAS. Diferença ~48h (Entre 24h e 72h).
-- Valor Reserva: 800.00 -> Multa Esperada: 400.00
INSERT INTO RESERVA (DATA_INICIO, DATA_FIM, DATA_CHECKIN, DATA_CHECKOUT, VALOR_RESERVA, FORMA_PAGAMENTO, STATUS_RESERVA, ID_CATEGORIA, ID_QUARTO, ID_HOSPEDE, ID_FUNCIONARIO) VALUES
    (
        DATEADD('HOUR', 14, CAST(DATEADD('DAY', 2, CURRENT_DATE) AS TIMESTAMP)),
        DATEADD('HOUR', 12, CAST(DATEADD('DAY', 4, CURRENT_DATE) AS TIMESTAMP)),
        NULL, NULL,
        800.00, 'CREDITO', 'CANCELADO',
        (SELECT ID_CATEGORIA FROM CATEGORIA_QUARTO WHERE NOME_CATEGORIA = 'Master'),
        NULL,
        (SELECT ID_HOSPEDE FROM HOSPEDE WHERE NOME_HOSPEDE LIKE 'Roberto%'),
        (SELECT ID_FUNCIONARIO FROM FUNCIONARIO WHERE NOME_FUNCIONARIO LIKE 'Ana%')
...
INSERT INTO CANCELAMENTO (MOTIVO, DATA_CANCELAMENTO, VALOR_MULTA, ID_RESERVA) VALUES
    (
        ...
        CURRENT_TIMESTAMP,
        400.00,           -- O Service calculou 50% de 800.00
        (SELECT MAX(ID_RESERVA) FROM RESERVA WHERE STATUS_RESERVA = 'CANCELADO' AND VALOR_RESERVA = 800.00)
    );

-- CASO C: SEM MULTA (0%) - Cancelou com muita antecedência
-- Reserva para daqui a 10 DIAS. Diferença > 72h.
-- Valor Reserva: 5000.00 (Reserva cara, mas multa zero).
-- NÃO DEVE APARECER NO RELATÓRIO (pois filtramos multa > 0).
INSERT INTO RESERVA (DATA_INICIO, DATA_FIM, DATA_CHECKIN, DATA_CHECKOUT, VALOR_RESERVA, FORMA_PAGAMENTO, STATUS_RESERVA, ID_CATEGORIA, ID_QUARTO, ID_HOSPEDE, ID_FUNCIONARIO) VALUES
    (
        DATEADD('HOUR', 14, CAST(DATEADD('DAY', 10, CURRENT_DATE) AS TIMESTAMP)),
        DATEADD('HOUR', 12, CAST(DATEADD('DAY', 15, CURRENT_DATE) AS TIMESTAMP)),
        NULL, NULL,
        5000.00, 'PIX', 'CANCELADO',
        (SELECT ID_CATEGORIA FROM CATEGORIA_QUARTO WHERE NOME_CATEGORIA = 'Presidencial'),
        NULL,
        (SELECT ID_HOSPEDE FROM HOSPEDE WHERE NOME_HOSPEDE LIKE 'João%'),
        (SELECT ID_FUNCIONARIO FROM FUNCIONARIO WHERE NOME_FUNCIONARIO LIKE 'Carlos%')
...
INSERT INTO CANCELAMENTO (MOTIVO, DATA_CANCELAMENTO, VALOR_MULTA, ID_RESERVA) VALUES
    (
        ...
        CURRENT_TIMESTAMP,
        0.00,             -- Multa Zero
        (SELECT MAX(ID_RESERVA) FROM RESERVA WHERE STATUS_RESERVA = 'CANCELADO' AND VALOR_RESERVA = 5000.00)
    );

-- CASO D: MULTA ANTIGA (Para testar filtro de data e ordenação)
-- Cancelado mês passado. Multa alta (2000.00).
INSERT INTO RESERVA (DATA_INICIO, DATA_FIM, DATA_CHECKIN, DATA_CHECKOUT, VALOR_RESERVA, FORMA_PAGAMENTO, STATUS_RESERVA, ID_CATEGORIA, ID_QUARTO, ID_HOSPEDE, ID_FUNCIONARIO) VALUES
    (
        '2023-12-25 14:00:00', '2023-12-30 12:00:00', NULL, NULL,
        2000.00, 'CREDITO', 'CANCELADO',
        (SELECT ID_CATEGORIA FROM CATEGORIA_QUARTO WHERE NOME_CATEGORIA = 'Master'),
        NULL,
        (SELECT ID_HOSPEDE FROM HOSPEDE WHERE NOME_HOSPEDE LIKE 'Maria%'),
        (SELECT ID_FUNCIONARIO FROM FUNCIONARIO WHERE NOME_FUNCIONARIO LIKE 'Lucio%')
...
INSERT INTO CANCELAMENTO (MOTIVO, DATA_CANCELAMENTO, VALOR_MULTA, ID_RESERVA) VALUES
    (
        'Problemas pessoais antigos',
        '2023-12-24 10:00:00', -- Data antiga
        2000.00,
        (SELECT MAX(ID_RESERVA) FROM RESERVA WHERE STATUS_RESERVA = 'CANCELADO' AND VALOR_RESERVA = 2000.00)
    );