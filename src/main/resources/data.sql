...
-- Roberto reservou de 01/10 a 05/10.
-- Chegou às 14:15 do dia 1 e saiu às 11:30 do dia 5.
...
-- Fernanda reservou de Hoje até daqui a 3 dias.
-- Checkin realizado agora.
INSERT INTO RESERVA (DATA_INICIO, DATA_FIM, DATA_CHECKIN, DATA_CHECKOUT, VALOR_RESERVA, FORMA_PAGAMENTO, STATUS_RESERVA, ID_CATEGORIA, ID_QUARTO, ID_HOSPEDE, ID_FUNCIONARIO) VALUES
...
-- Pedro cancelou uma reserva para daqui a 10 dias.
INSERT INTO RESERVA (DATA_INICIO, DATA_FIM, DATA_CHECKIN, DATA_CHECKOUT, VALOR_RESERVA, FORMA_PAGAMENTO, STATUS_RESERVA, ID_CATEGORIA, ID_QUARTO, ID_HOSPEDE, ID_FUNCIONARIO) VALUES
...
-- 5. HISTÓRICO: Maria Oliveira
-- Passado simples (apenas data).
INSERT INTO RESERVA (DATA_INICIO, DATA_FIM, DATA_CHECKIN, DATA_CHECKOUT, VALOR_RESERVA, FORMA_PAGAMENTO, STATUS_RESERVA, ID_CATEGORIA, ID_QUARTO, ID_HOSPEDE, ID_FUNCIONARIO) VALUES
...
-- 6. FUTURO: Pedro Santos para o Natal
INSERT INTO RESERVA (DATA_INICIO, DATA_FIM, DATA_CHECKIN, DATA_CHECKOUT, VALOR_RESERVA, FORMA_PAGAMENTO, STATUS_RESERVA, ID_CATEGORIA, ID_QUARTO, ID_HOSPEDE, ID_FUNCIONARIO) VALUES
...
-- 7. CANCELADO: João Silva em Agosto
INSERT INTO RESERVA (DATA_INICIO, DATA_FIM, DATA_CHECKIN, DATA_CHECKOUT, VALOR_RESERVA, FORMA_PAGAMENTO, STATUS_RESERVA, ID_CATEGORIA, ID_QUARTO, ID_HOSPEDE, ID_FUNCIONARIO) VALUES
...
-- 8. FUTURO COM QUARTO: Roberto Almeida para semana que vem
INSERT INTO RESERVA (DATA_INICIO, DATA_FIM, DATA_CHECKIN, DATA_CHECKOUT, VALOR_RESERVA, FORMA_PAGAMENTO, STATUS_RESERVA, ID_CATEGORIA, ID_QUARTO, ID_HOSPEDE, ID_FUNCIONARIO) VALUES
...
-- 10. CHECKIN HOJE: Walk-in do Pedro Santos (chegou hoje sem reserva prévia)
INSERT INTO RESERVA (DATA_INICIO, DATA_FIM, DATA_CHECKIN, DATA_CHECKOUT, VALOR_RESERVA, FORMA_PAGAMENTO, STATUS_RESERVA, ID_CATEGORIA, ID_QUARTO, ID_HOSPEDE, ID_FUNCIONARIO) VALUES
